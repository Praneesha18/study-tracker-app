  ...
  return (
    <nav className="bg-background shadow-sm sticky top-0 z-50">
      <div className="max-w-6xl mx-auto flex justify-between items-center px-4 sm:px-6 py-4">
        <Link href="/">
          <span className="text-2xl font-bold tracking-wide text-secondary cursor-pointer hover:opacity-90 transition">
            Study Tracker
          </span>
        </Link>

        <ul className="flex items-center space-x-4 sm:space-x-6 text-base font-medium ">
          <li>
            <Link href="/">
